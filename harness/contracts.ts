...
// "built-agent" (ADR-0129, P-AGENT.1) — an agent authored in the Agent Builder and run inside LUCID; given
...
// "built-agent" (ADR-0129, P-AGENT.1) — the profile a Builder-authored agent runs under; its non-destructive
...
export const EVENT_NAMES = [
  ...
  "skill_activated",
  // P-AGENT (ADR-0129) — the Agent Builder lifecycle. Metadata only (spec_id/name/counts/verdict),

...
## P-PREVIEW.6b: the agent READS the live preview DOM — postMessage bridge + held relay (ADR-0148)
...
## P-PREVIEW.6a: the agent reviews its work live — Preview panel glow + "testing" pill (ADR-0148)

...
**Settings clone parity + AskSage GPT-5.6 (ADR-0208 / ADR-0209) — 2026-07-14**
...
**AskSage lockdown enforced server-side, fail-closed (ADR-0211) — 2026-07-14**
...
**knowledge_search: RAG grounding for non-AskSage users (ADR-0214, increment 1) — 2026-07-14**
...
**Bring-your-own-embeddings ApiEmbedder (ADR-0215, increment 2 part 1) — 2026-07-14**
...
**Semantic search: Test-endpoint + Re-index (ADR-0215 finishers) — 2026-07-14**
...
**Shared-session viewer: thinking + tools, full-window layout (ADR-0216) — 2026-07-14**

...
- **next:** addon-side follow-on per ADR-A024: distribute LAI-GOV-PACK allowlists into the managed models block via the ADR-0068/A010 channel; core enforcement now consumes them for real.

...
- **next:** trigger `build-desktop.yml` (push a tag or manual dispatch) to cut the bundled installers; version bump + release cut folding P-PROV.2 / P-LOCAL.4 / Opus 5 readiness / TLDR+exec / dictation / bundled Whisper.

...
## P-VOICE.2: live read-aloud from the composer - voice picker + auto-speak (ADR-0246)
...
## P-VOICE.3: engine readiness in the picker + hands-free conversation mode (extends ADR-0246)
...
## P-VOICE.4: the speech equalizer + the draggable "LUCID Agent [Voice]" panel (ADR-0247)
...
## P-VOICE.5: in conversation mode the agent answers for the EAR, automatically (ADR-0247)
...
## P-VOICE.6: spoken progress cues + a conversation-mode hotkey (ADR-0248)

...
const PROV_HINTS: Record<string, string> = {
  ...
  "google-vertex": "<b>Google Cloud Vertex AI = Gemini Enterprise.</b> Either paste a <b>GOOGLE_CLOUD_API_KEY</b> above, OR leave it blank and use Application Default Credentials: run <code>gcloud auth application-default login</code> (or point to a service-account JSON), and set the <b>project</b> + <b>location</b> below. This is the enterprise-governed Gemini path, distinct from the consumer AI Studio key on the Gemini card.",

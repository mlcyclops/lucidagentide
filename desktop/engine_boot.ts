...
// step. History: ADR-0250 first CLAMPED the installer away from Program Files as a mitigation;
// ADR-0262 re-allowed per-machine installs once the compiled engine (ADR-0251) + the strict CI boot

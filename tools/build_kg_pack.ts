...
export const PACK_CATALOG: PackCatalogEntry[] = [
  ...
  { key: "proposal",    folder: "DoW Business Dev/PROPOSAL MGR",          name: "Capture & Proposal Manager",           role: "Capture / Proposal Manager",                     desc: "Shipley-style capture and proposals: color teams, win themes, and compliance matrices.", licensing: "one-time", id: "capture-proposal-manager" },
  ...
  { key: "pm-evm",      folder: "Program Manager",                        name: "Program Manager (EVM)",                role: "Program / Project Manager",                      desc: "CMMI and Earned Value Management: IMS, EAC, variance analysis, and program controls.", licensing: "one-time", id: "program-manager-evm" },

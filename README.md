...
and the **runtime execution boundary** (OS-isolated exec + mediated egress). **Newest (v1.14.0):**
...
**3,300+ tests** across the harness (1,066), the desktop shell (2,183), and the Python
